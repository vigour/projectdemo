...
public class HttpClientUtil {
	 ...
	 private static final  int pagecount = 2;
	    ...
	    private static final String SCORE_URL = "http://testbed02.flnettv.com/apiscore/moviescore";
...
//	                config(httppost);
	                ...
	                params.put("mvid", (UUID.randomUUID().toString()).replaceAll("-", ""));
	                params.put("score", random.nextInt(5));
	                // 启动线程抓取
	                executors.execute(new PostRunnable(SCORE_URL, params, countDownLatch));
	            }
	    ...
	    static class PostRunnable implements Runnable {
	        ...
	        public PostRunnable(String url, Map<String, Object> params, CountDownLatch countDownLatch) {
	            this.url = url;
	            this.params = params;
	            this.countDownLatch = countDownLatch;
	        }
