...
public class HttpClientAdvertiseUtil {
	 ...
	 private static final  int pagecount = 2000;
	    ...
	    private static final String SCORE_URL = "http://openapi.logs.ptsharp.gitv.tv/apiscore/uploadmoviescore";
...
//	                "http://blog.csdn.net/catoop/article/details/38849497" };
	        ...
	        try {
	            ...
	            CountDownLatch countDownLatch = new CountDownLatch(pagecount * urisToPost.length);
